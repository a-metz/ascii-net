...
def test():
    ...
    gen, char = training_data.get_sample_generator(charset=param.PRINTABLE_ASCII, font=fnt, dim=param.DEFAULT_DIM, offset=param.DEFAULT_OFFSET, transform=trns)

    for lbl, gly in training_data.batch_generator(gen, 100):
        console.draw(gly)
        print()
